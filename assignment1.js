...
console.log(`contry 1 have= ${population/2}M population`)
console.log(`the increased population in country1 is =  ${population+1}M`)
// console.log(population)
let Finland =6
let average = 33
console.log(population>Finland)
console.log(population<average)
console.log(country+ ' is in '  +continent+ ' and its ' +population+ ' M people speak ' +language );



// =========================Strings and Template Literals============================

// Recreate the 'description' variable from the last assignment, this time using the 
...
if (population>33) {
    ...
    console.log(`${country}population is ${33-population} M below average` )
    }
...
if (language==="english" && population<50 && !IsIsland) {
    console.log(`you should have live in ${country}`)
}
else{
...
console.log(population>33 ? console.log(`${country} s is above average`):console.log(`${country} s is below average`))
